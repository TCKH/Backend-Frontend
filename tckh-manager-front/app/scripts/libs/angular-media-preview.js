...
.directive('mediaPreview', function($log, $document) {
    ...
    var directive = {
        restrict: 'E',
        scope: { model: '=?' },
        template:   '<input type="file" class="btn btn-primary col-md-6" accept="image/*,video/*,audio/*" ng-model="model" />' +
                    '<input type="button" class="btn btn-danger" style="margin-left: 50px;" ng-click="clearPreview()" value="X" />',
        link: _link
    }
